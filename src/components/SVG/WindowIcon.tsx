...
export const WindowIcon: FC<WindowIconProps> = ({
	className = undefined,
	size = 32,
}) => {
	return (
		<svg
			...
			className={className}
			stroke={'#000000'}
			strokeWidth={10.818 / size}
		>
			<g>
				<path
					d="M10.048,0.773H0.775C0.349,0.773,0,1.119,0,1.544v7.73c0,0.426,0.349,0.771,0.775,0.771h9.272
